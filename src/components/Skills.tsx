	...
	const SkillCard = ({ category, index }) => {
		...
		return (
			<div
				ref={cardRef}
				key={category.title}
				className={`bg-theme-dark-surface/40 backdrop-blur-sm rounded-xl p-5 border border-white/5 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-500 ${
					cardInView
			...
			>
				<div className="flex items-center gap-3 mb-4">
					<div className="w-10 h-10 rounded-lg bg-gradient-to-br from-theme-accent-primary/20 to-theme-accent-secondary/20 flex items-center justify-center">
						<category.icon
							size={20}
	...
	return (
		...
		>
			...
			<div className="absolute inset-0 pointer-events-none">
				<div className="absolute top-0 left-1/4 w-80 h-80 bg-theme-accent-primary/5 rounded-full blur-3xl"></div>
				<div className="absolute bottom-0 right-1/4 w-96 h-96 bg-theme-accent-secondary/5 rounded-full blur-3xl"></div>
				<div className="absolute top-1/3 right-1/3 w-64 h-64 bg-purple-500/5 rounded-full blur-3xl"></div>
			</div>
			...
			<div ref={ref} className="max-w-6xl mx-auto relative z-10">
				...
				>
					<div className="relative overflow-hidden py-6">
						<div className="absolute inset-y-0 left-0 w-24 bg-gradient-to-r from-theme-dark-bg to-transparent z-10"></div>
						<div className="absolute inset-y-0 right-0 w-24 bg-gradient-to-l from-theme-dark-bg to-transparent z-10"></div>
						<MovingCarousel
							items={skillsCarouselItems}
							direction="left"
							speed={40}
							className="py-4"
							itemClassName="mx-6 w-16 h-16 filter drop-shadow-lg hover:scale-125 transition-transform duration-300"
						/>
					</div>
				</div>
				...
				>
					...
					<div className="relative overflow-hidden py-6">
						...
						<MovingCarousel
							...
							speed={50}
							className="py-6"
							itemClassName="mx-8 w-32 h-32 filter drop-shadow-xl hover:scale-110 transition-transform duration-300"
						/>
					</div>
				</div>
			</div>
